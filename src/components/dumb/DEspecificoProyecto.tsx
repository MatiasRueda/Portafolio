...
export default function DEspecificoProyecto(props: {
  proyecto: Proyecto;
  demo?: JSX.Element | false;
}): JSX.Element {
  return (
    <div className="cont-proyecto-informacion">
      ...
      <SHerramientas
        titulo="Lenguajes utilizados para este proyecto: "
        herramientas={props.proyecto.lenguajes}
      />
      <SHerramientas
        titulo="Frameworks utilizados para este proyecto: "
        herramientas={props.proyecto.framework}
      />
      <SHerramientas
        titulo="Test utilizados usadas:  "
        herramientas={props.proyecto.tests}
      />
      <SHerramientas
        titulo="Otras tecnologias usadas:  "
